...
import com.xinle.lottery.base.CrashHandler;
 ...
 */
public class XinLeApp extends Application {
    public static final boolean SERVER_TYPE = false;//true:正式服；false：测试服
    private static XinLeApp sApp;
    ...
    public void onCreate() {
        ...
        if (SERVER_TYPE) {
            ...
            baseUrl = "http://api.xl.test.com";//测试服
        }
    ...
    public static XinLeApp getInstance() {
        return sApp;
    }
