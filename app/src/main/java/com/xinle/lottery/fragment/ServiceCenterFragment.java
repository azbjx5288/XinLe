...
import com.xinle.lottery.data.ServiceParam;
import com.xinle.lottery.data.UserInfo;
import com.xinle.lottery.material.ImageFilePath;
...
public class ServiceCenterFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        userInfo = XinLeApp.getUserCentre().getUserInfo();
    ...
    private void initView() {
        ...
        webView.loadUrl("http://s3.myapple888.com/index/app?companyId=70722527&style=default&mode=4&token="+ userjson);
