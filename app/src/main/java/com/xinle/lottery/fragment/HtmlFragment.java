...
import com.xinle.lottery.material.SaveImageUtils;
import com.xinle.lottery.util.DownPicUtil;
...
//        initImmersionBarEnabled();
    ...
    void callCard(String path) {
        saveImageInto(XinLeApp.getInstance().getBaseUrl() + path);
    }
    ...
    void onCardNeverAsk() {
        ToastUtils.showShortToast(getActivity(), "若想使用支付，请到“设置-应用程序-新乐”中开启读写SD卡权限");
    }
