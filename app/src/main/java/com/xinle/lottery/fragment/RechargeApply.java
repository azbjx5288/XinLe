...
import com.xinle.lottery.component.TabPageAdapter;
import com.xinle.lottery.component.WrapContentHeightViewPager;
import com.xinle.lottery.data.ChannelInfoCommand;
import com.xinle.lottery.data.ChannelInfoRecharge;
import com.xinle.lottery.data.RechargeCallback;
import com.xinle.lottery.data.RechargeCallbackCommand;
import com.xinle.lottery.data.RechargeChannelConfig;
import com.xinle.lottery.data.RechargeConfigCommand;
...
public class RechargeApply extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
    ...
    private void getChannelInfoLoad(double money) {
        ...
        channelInfoCommand.setPlatform_id(cardRecharge.getId());
    ...
    private void getRechargeCallback() {
        ...
        callbackCommand.setOrder_no(channelInfo.getOrderNo());
