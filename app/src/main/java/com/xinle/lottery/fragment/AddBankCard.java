...
import com.xinle.lottery.component.MyTextWatcher;
import com.xinle.lottery.component.OptionPicker;
import com.xinle.lottery.data.BankOpenCommand;
import com.xinle.lottery.data.BindCardCommand;
import com.xinle.lottery.data.BindCardDetail;
import com.xinle.lottery.data.ChangeCardCommand;
import com.xinle.lottery.data.City;
import com.xinle.lottery.data.County;
import com.xinle.lottery.data.Province;
import com.xinle.lottery.pattern.AddressInitTask;
import com.xinle.lottery.user.UserCentre;
import com.xinle.lottery.util.ConvertUtils;
        ...
        if (verification()) {
            ...
            try {
                ...
                if (revise) {
                    ...
                    changeCommand.setToken(userCentre.getUserInfo().getToken());
