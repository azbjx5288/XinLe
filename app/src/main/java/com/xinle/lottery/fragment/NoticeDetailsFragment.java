...
import com.xinle.lottery.data.NoticeDetail;
import com.xinle.lottery.data.NoticeDetailCommand;
import com.xinle.lottery.data.NoticeList;
...
public class NoticeDetailsFragment extends BaseFragment {
    ...
    private void loadNoticeDetail(Notice notice) {
        ...
        command.setToken(userCentre.getUserInfo().getToken());//4:公告；3:banner
