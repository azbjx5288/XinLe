...
import com.xinle.lottery.data.Order;
import com.xinle.lottery.data.OrderListCommand;
import com.xinle.lottery.data.Type;
import com.xinle.lottery.data.TypeCommand;
...
public class BalanceDetailsFragment extends BaseFragment {
    ...
    private void loadData(int page) {
        ...
        if(orderType!=0){
            command.setType_id(typesArray.get(orderType));
        }
        command.setToken(XinLeApp.getUserCentre().getUserInfo().getToken());
