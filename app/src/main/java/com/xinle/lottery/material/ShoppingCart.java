...
import com.xinle.lottery.data.Balls;
...
public class ShoppingCart {
    ...
    private LucreMode lucreMode = LucreMode.fromCode(XinLeApp.getUserCentre().getLucreMode()); /** 当前金额模式 */
    ...
    private int prizeGroup = XinLeApp.getUserCentre().getPrizeGroup();    /** 奖金组 **/
    ...
    public void setPlanBuyRule(int multiple, int tracenum, boolean stopOnWin) {
        ...
        this.lucreMode = LucreMode.fromCode(XinLeApp.getUserCentre().getLucreMode());
        this.prizeGroup = XinLeApp.getUserCentre().getPrizeGroup();
        ruleCount();
        codePurify();
        ordersPurify();
    }
